...
public class Menu extends javax.swing.JFrame implements Runnable, ThreadFactory {
    ...
    private void result_freldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_result_freldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_result_freldActionPerformed
    ...
    public void run() {
        ...
        do {
            ...
            if (result != null) {
                ...
                result_freld.setText(getDbMysql.getDb( Integer.parseInt(result.getText())));
            }
