...
public class AbsLay implements LayoutManager2, Serializable {
    ...
    public Dimension preferredLayoutSize(Container var1) {
        ...
        while(var4.hasMoreElements()) {
            ...
            absCons var6 = (absCons)this.constraints.get(var5);
    ...
    public void layoutContainer(Container var1) {
        ...
        for(Enumeration var2 = this.constraints.keys(); var2.hasMoreElements(); var3.setBounds(var4.x, var4.y, var6, var7)) {
            ...
            var4 = (absCons)this.constraints.get(var3);
